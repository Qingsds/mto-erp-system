  ...
  return (
    <>
      <div className='flex flex-col flex-1 overflow-hidden'>
        <PageHeader
          title='新建对账单'
          subtitle='选择客户与发货明细，系统将自动计算应收金额'
          onBack={onCancel}
          onCancel={onCancel}
          onSubmit={onSubmit}
          ...
          <div className='flex flex-col gap-4 lg:flex-row lg:items-start lg:gap-8'>
            ...
            <div className='flex-1 min-w-0 flex flex-col gap-4'>
              {customer && (
                <FormCard
                  title='选择发货单'
                  subtitle={fetchingDeliveries ? "加载中..." : `找到 ${deliveries.length} 张发货单（最多显示 50 张）`}
                >
              ...
              >
                <div className='flex flex-col gap-3'>
                  ...
                  <button
                    ...
                    className='flex w-full items-center justify-center gap-2 border border-dashed border-border bg-background px-4 py-3 text-sm text-muted-foreground transition-colors hover:border-primary/50 hover:bg-muted/40 hover:text-foreground'
                  >
      ...
      <CustomerFormSheet
        ...
        onSubmitted={nextCustomer => {
          ...
          selectCustomer({ id: nextCustomer.id, name: nextCustomer.name })
        }}
      />
    </>
  )
