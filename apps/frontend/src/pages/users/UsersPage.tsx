...
function RoleBadge({ role }: { role: UserListItem["role"] }) {
  ...
  return (
    <span
      className={`inline-flex border px-2 py-0.5 text-[11px] ${className}`}
    >
      {label}
    </span>
  )
...
export function UsersPage() {
  ...
  const [editingUser, setEditingUser] = useState<UserListItem | null>(
    null,
  )
  ...
  return (
    <>
                    ...
                    >
                      ...
                      <div className='mt-3 flex gap-2'>
                        ...
                        <Button
                          type='button'
                          variant={
                            user.isActive ? "secondary" : "default"
                          }
                          className='h-9 flex-1'
                          onClick={() =>
      ...
      <UserFormSheet
        ...
        onUpdate={(id, payload) =>
          updateUser.mutateAsync({ id, ...payload })
        }
      />
    </>
  )
