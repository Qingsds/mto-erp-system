...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      style={{
        gap: "var(--erp-gap, 12px)",
        ...style,
      }}
      className={cn(
        "group/card flex flex-col overflow-hidden rounded-2xl bg-card py-6 text-sm text-card-foreground ring-1 ring-foreground/10 has-[>img:first-child]:pt-0 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl",
        className,
      )}
      {...props}
    />
